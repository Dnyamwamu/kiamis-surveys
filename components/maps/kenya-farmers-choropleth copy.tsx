...
interface KenyaFarmersChoroplethProps {
...
export default function KenyaFarmersChoropleth({
  kiamisData = [],
}: KenyaFarmersChoroplethProps) {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Farmer Distribution Map</CardTitle>
              <CardDescription>
        ...
        <div className="fixed inset-0 z-50 bg-background flex flex-col">
          <div className="flex items-center justify-between p-2 md:p-4 border-b shrink-0">
            <h2 className="text-sm md:text-lg font-semibold">
              Farmer Distribution Map - Fullscreen View
            </h2>
            <div className="flex gap-2">
              <Button
                variant="outline"
          ...
          <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-96 flex-col gap-4 p-4 overflow-y-auto border-l">
