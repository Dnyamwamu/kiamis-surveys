...
interface KenyaVaccinationChoroplethProps {
...
export default function KenyaVaccinationChoropleth({
  kiamisData = [],
}: KenyaVaccinationChoroplethProps) {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Vaccination Distribution Map</CardTitle>
              <CardDescription>
          ...
          <div className="relative flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full lg:w-[450px] flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <h4 className="text-sm font-semibold mb-2">
                    Counties by Vaccination Distribution
                  </h4>
        ...
        <div className="fixed inset-0 z-50 bg-background flex flex-col">
          <div className="flex items-center justify-between p-2 md:p-4 border-b shrink-0">
            <h2 className="text-sm md:text-lg font-semibold">
              Vaccination Distribution Map - Fullscreen View
            </h2>
