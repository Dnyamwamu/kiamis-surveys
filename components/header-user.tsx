...
import { getRoleName } from "@/lib/config/roles";
...
export function HeaderUser() {
  ...
  // Use the new structure first, then fallback to getRoleName if it's a number/string numeric from profile
  const roleLabel =
    user.role || getRoleName(user.profile?.role) || "Unknown Role";
